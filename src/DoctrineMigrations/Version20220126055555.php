 ...
 */
final class Version20220126055555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE JUN_OperatorsGroups CHANGE taxon_id taxon_id INT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE JUN_OperatorsGroups CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE taxon_id taxon_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE JUN_OperatorsWork MODIFY id INT NOT NULL');
