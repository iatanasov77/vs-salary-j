 ...
 */
final class Version20220125212413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE JUN_OperatorsGroups ADD deleted_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE JUN_OperatorsGroups DROP deleted_at');
        $this->addSql('ALTER TABLE JUN_OperatorsWork MODIFY id INT NOT NULL');
